...
**Frameworks & Libraries:** React JS, Spring Boot, FastAPI, NumPy, Pandas, XGBoost, Dash, Plotly, Matplotlib

**Databases:** MySQL, Firebase Firestore

**AI & Automation:** Vapi (GPT-4.1), n8n Cloud, Deepgram ASR, Tesseract OCR

**IoT & Hardware:** ESP32, Arduino IDE, ThingSpeak

**Tools:** GitHub, VS Code, IntelliJ IDEA, Wireshark
...
Interactive desktop application for analysing and visualising historical and real-time stock market data using Python, Pandas, SQL, and Tkinter.

`Python` `Pandas` `SQL` `Tkinter`
...
- 📧 231301@psgtech.ac.in
- 💼 [LinkedIn](https://www.linkedin.com/in/abarajitha-sk)
